      ...
      <div className="mx-auto max-w-[800px]">
        <section className="flex flex-col justify-between gap-4 sm:flex-row sm:items-start">
          ...
          <Link
            ...
            className="inline-flex h-10 items-center justify-center gap-2 rounded-xl bg-[#075bd8] px-4 text-xs font-bold text-white shadow-sm transition hover:bg-[#064fb9]"
          >
        ...
        <section className="mt-3">
          {appointments.isLoading ? (
            ...
            <div className="grid min-h-72 place-items-center rounded-lg border border-[#cfd7e7] bg-white p-6 text-center">
              ...
              <Link
                to="/patient/request-appointment"
                className="mt-4 inline-flex h-10 items-center justify-center gap-2 rounded-lg bg-[#075bd8] px-4 text-xs font-semibold text-white hover:bg-[#064fb9]"
              >
                <CalendarPlus className="size-4" />
                Envoyer une demande
              </Link>
        ...
        <div className="p-5">
          ...
          <div className="mt-6 flex justify-end gap-2 border-t pt-4">
            ...
            <button
              ...
              onClick={() =>
                cancelTarget?.id && cancelMutation.mutate(cancelTarget.id)
              }
